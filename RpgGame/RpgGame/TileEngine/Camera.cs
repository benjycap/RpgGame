...
{
    // Class holds camera position, its speed, zoom and the rectangle to be drawn to
    // Also holds methods to move camera's position based on user input
    ...
    public class Camera
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            // Create a normalised unit vector from directions in order to avoid increased diagonal movement.
