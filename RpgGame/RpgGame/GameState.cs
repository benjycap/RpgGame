...
namespace RpgGame
{
    ...
    public abstract partial class GameState : DrawableGameComponent
    {
        ...
        // Check each game component. If it is a drawable component, and visible, draw it.
        ...
        // Event handler for OnStateChange in GameStateManager class
